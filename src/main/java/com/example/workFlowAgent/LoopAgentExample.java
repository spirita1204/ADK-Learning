...
public class LoopAgentExample {
    ...
    LlmAgent initialWriterAgent =
        LlmAgent.builder()
            ...
            .afterAgentCallback(ctx -> {
              printAgentOutput(ctx.agentName(), ctx.state());
              return Maybe.empty();
            })
  ...
  private static void printAgentOutput(String agentName, Map<String, Object> state) {
    System.out.println("\n==============================");
    System.out.println("AfterAgentCallback → " + agentName);
    System.out.println("==============================\n");
  }
}